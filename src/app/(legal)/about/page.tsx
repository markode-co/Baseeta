...
export const metadata: Metadata = {
  title: "نبذة عن بسيطة | نظام إدارة المطاعم",
  description: "تعرّف على بسيطة — نظام إدارة المطاعم السحابي الذي يخدم آلاف المطاعم.",
};
...
const VALUES = [
  ...
  { icon: Heart,  title: "نجاحك هو نجاحنا", desc: "لسنا مجرد مزود خدمة — نحن شركاء في نجاح مطعمك. دعمنا متاح 24/7 لأن مطعمك لا ينام." },
...
const TEAM_HIGHLIGHTS = [
  ...
  "فريق متخصص في صناعة المطاعم والضيافة",
      ...
      <section className="bg-gradient-to-b from-blue-600 to-blue-700 text-white py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-blue-100 text-lg leading-relaxed max-w-2xl mx-auto">
            بدأنا بسؤال بسيط: لماذا إدارة المطعم معقدة جداً؟ فبنينا الجواب — نظام سحابي متكامل يجعل كل شيء أسهل.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-3xl mx-auto px-4 py-14 space-y-14">
        ...
        <section>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4 text-slate-600 leading-relaxed">
            <p>
              في عام 2023، لاحظ مؤسسو بسيطة أن أصحاب المطاعم يعانون يومياً من أنظمة قديمة ومعقدة تستهلك وقتهم بدلاً من مساعدتهم. كانت أنظمة الكاشير تتعطل، والتقارير مبعثرة، وإدارة الموظفين والمخزون تتم على أوراق.
            </p>
            <p>
            ...
            <p>
              اليوم، تثق بنا أكثر من 2,500 مطعم في مصر ودول الخليج، من المطاعم الصغيرة إلى سلاسل المطاعم المتعددة الفروع.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-blue-600 rounded-2xl p-6 text-white">
            <p className="text-xl font-bold leading-relaxed">
              &ldquo;تمكين أصحاب المطاعم من التركيز على ما يحبونه — الطعام الرائع والضيافة الأصيلة — بينما نتولى نحن تعقيدات الإدارة.&rdquo;
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6">
            <p className="text-slate-600 leading-relaxed mb-5">
              يتكون فريق بسيطة من مهندسين ومتخصصين في المنتجات وخبراء في صناعة المطاعم، يجمعهم شغف واحد: بناء أدوات تُحدث فرقاً حقيقياً.
            </p>
